...
public class SignupOne extends JFrame implements ActionListener
{
    ...
    long random;
    JTextField nameTextField,fnameTextField,emailTextField,addressTxtField,cityTxtField, stateTxtField,pinTxtField;
    JButton next;
    ...
    SignupOne() {
        ...
        setLayout(null);
        // math.abs fro positive to negative convesion
        ...
        marritalgrGroup.add(married);
        marritalgrGroup.add(unmarried);
        marritalgrGroup.add(other);
        ...
        pinTxtField.setFont(new Font("Raleway",Font.BOLD,14));
        pinTxtField.setBounds(300, 590, 400, 30);
        add(pinTxtField);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        String name=nameTextField.getText(); //setTecxt
