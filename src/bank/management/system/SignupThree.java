...
public class SignupThree extends JFrame implements ActionListener {
    ...
    String formno;
     ...
     SignupThree(String formno) {
         ...
         c7=new JCheckBox("I Hereby Declare thet the above entered details are correct to the best of my knowledge");
         ...
         cancal.setBounds(420,720,100,30);
     ...
     public void actionPerformed(ActionEvent ae)
     {
         if(ae.getSource()==submit)
         {
             ...
             {
                 facility=facility+" EMAIL & SMS Alerte";
             }
